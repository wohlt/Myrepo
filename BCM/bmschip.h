 ...
 *	2.0			|	A. Weiss		|	15.06.2016	|	Deklaration: Zellen_pro_Board
 *	2.1			|	A. Weiss		|	20.07.2016	|	Deklaration: bmschip_read_IntADC, evaluate_Current
 *	2.1			|	A. Weiss		|	29.07.2016	|	Deklaration: für Recommend-Balancing-Funktion
 *	2.2			|	A. Weiss		|	04.08.2016	|	Makros zum zerlegen einer 32Bit Zahl in vier 8Bit Zahlen
 *	
 *
 */
...
// *** Defines *****************************************************************************
#define MAX_NUM_OF_CELLS				192	//maximale Anzahl an erlaubten Zellen fuer dieses Programm
// *****************************************************************************************

// *** Bitmanipulation *********************************************************************
// Byte Makros
#define MERGE_BYTES(LOW,HIGH) ((HIGH << 8)|LOW)	//16 Bit-Zahl aus zwei Bytes erstellen
#define GET_LOW_BYTE(x) ((uint8_t)x)			//Untere Bits aus der 16 Bit-Zahl auslesen
#define GET_HIGH_BYTE(x) ((uint8_t)(x >> 8))	//Obere Bits aus der 16 Bit-Zahl auslesen
// *** Structs *****************************************************************************
typedef struct
{
	uint8_t config[6];		//Konfigurationsdaten
	uint8_t adcv[4][4];		//Lesebefehle fuer Zellspannungsgruppen (A - D)
} ltc6804_s;
// *****************************************************************************************
...
//void Zellen_pro_Board2(uint8_t *Cells); Alternative
// *****************************************************************************************

// *** Spannungsmessfunktionen *************************************************************
